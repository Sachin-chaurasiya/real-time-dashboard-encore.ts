...
/**
 * Client is an API client for the real-time-dashboard-q892 Encore application.
 */
...
export namespace dashboard {
    ...
    export class ServiceClient {
        ...
        public async sale(params: HandshakeRequest): Promise<StreamInOut<PostSale, Sale>> {
            ...
            return await this.baseClient.createStreamInOut(`/sale`, {query})
        }
    }
}
...
export namespace frontend {
    ...
    export class ServiceClient {
        ...
        public async salesDashboard(path: string[]): Promise<void> {
...
class BaseClient {
    ...
    constructor(baseURL: string, options: ClientOptions) {
        ...
        if (typeof window === "undefined") {
            this.headers["User-Agent"] = "real-time-dashboard-q892-Generated-TS-Client (Encore/v1.43.8)";
        }
